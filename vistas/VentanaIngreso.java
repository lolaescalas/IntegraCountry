...
public VentanaIngreso() {
    ...
    // MITAD IZQUIERDA: Fondo con degradado azul moderno
    ...
    btnIngresar.addActionListener(e -> {
        ...
        if (u.equals("admin") && p.equals("1234")) {
            JOptionPane.showMessageDialog(this, "Bienvenido, " + comboRoles.getSelectedItem());
        } else {
...
public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> new VentanaIngreso().setVisible(true));
}
}