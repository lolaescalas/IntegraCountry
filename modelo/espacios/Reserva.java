...
public class Reserva implements Cancelable {
    ...
    private int id; private String espacio; private String fecha; private String horario;
    ...
    public Reserva(String espacio, String fecha, String horario, Usuario solicitante) {
        this.id = contador++; this.espacio = espacio; this.fecha = fecha;
        this.horario = horario; this.solicitante = solicitante; this.estado = "PENDIENTE";
    }
