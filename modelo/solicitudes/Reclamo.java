...
public class Reclamo extends Solicitud {
    private Prioridad prioridad; private String asunto; private String descripcion;
    public Reclamo(AsignadorEmpleado asignador, Prioridad prioridad) { super(asignador); this.prioridad = prioridad; }
